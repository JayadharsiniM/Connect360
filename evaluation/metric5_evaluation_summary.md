...
- **Prices:** $100\%$ preserved ($50/50$). Numbers like `₹500`, `Rs. 1500`, and `₹3,500` are unaffected because currency symbols and commas break the pattern, and digit sequences are shorter than 10 characters.
